---
layout: post
title: Modding no Ready or Not
description: Algumas experimentações implementando modelos 3D no UE5
pin: false
categories: [MODDING]
tags: [UnrealEngine]
lang: br
...
{%
  ...
  title='Substituição de Sombrero e falas'
  autoplay=false
  loop=false
  muted=false
%}
...
{%
  ...
  title='Substituição de falas chilenas dos suspeitos'
  autoplay=false
  loop=false
  muted=false
%}
